...
class WXLoginHelper {
    ...
    public function wxlogin_and_make_session3rd($code) {


        $params = [
            'appid' => 'wx66c28fac4e8a7dff',
            'secret' => '39595d91594764990e3ef703647b1987',
            'js_code' => $code,
            'grant_type' => $this->config['grant_type']
        ];
        ...
        $reqData['session3rd'] = $this->randomFromDev(16);
//        //保留5天的缓存，10天后强制重新登录
//        cache($session3rd, [
//            'openid' => $data['openId'],
//            'sessionKey' => $sessionKey,
